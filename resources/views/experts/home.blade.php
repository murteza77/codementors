    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <!-- <a href="http://www.creative-tim.com">
                <div class="logo-container">
                    <div class="logo">
                        <img src="assets/img/logo.png" alt="Creative Tim Logo" rel="tooltip" title="<b>Code Mentors</b> something <b>Creative Tim</b>" data-placement="bottom" data-html="true">
                    </div>
                    <div class="brand">
                        I'm Jamshid
                    </div>
             ...
             <ul class="nav navbar-nav navbar-left">
                ...
                <li>
                    <a href="#" target="_blank" class="btn">
                        <i class="material-icons">cloud_download</i> See menters
                    </a>
                </li>
        ...
        <div class="collapse navbar-collapse" id="navigation-index">
            <ul class="nav navbar-nav navbar-right">
                   ...
                   <li>
                    <a href="#" target="_blank" class="btn">
                        <i class="material-icons">cloud_download</i> Sign in
                    </a>
                </li>
               <!--  <li>
                    <a rel="tooltip" title="Follow us on Twitter" data-placement="bottom" href="https://twitter.com/CreativeTim" target="_blank" class="btn btn-simple">
                        <i class="fa fa-twitter"></i>
                    </a>
                </li>
                <li>
                    <a rel="tooltip" title="Like us on Facebook" data-placement="bottom" href="https://www.facebook.com/CreativeTim" target="_blank" class="btn btn-simple">
                        <i class="fa fa-facebook-square"></i>
                    </a>
                </li>
                <li>
                    <a rel="tooltip" title="Follow us on Instagram" data-placement="bottom" href="https://www.instagram.com/CreativeTimOfficial" target="_blank" class="btn btn-simple">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="brand">
                        <h1>Code Mentors</h1>
                        <h3>Vulonteer mentors to help students</h3>
                    </div>
                </div>
            </div>
